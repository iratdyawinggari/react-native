...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#3DD5F0' : '#0196DA',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#3DD5F0',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  sTabBarActiveTextColor: '#00B5EC',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3DD5F0',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#00B5EC' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#00B5EC',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#fff',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#00B5EC' : '#fff',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#00B5EC',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#3DD5F0' : '#3498db',
  ...
  radioSelectedColorAndroid: '#4f6d7a',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#4f6d7a',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#4f6d7a',
  segmentBorderColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#3DD5F0',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#3DD5F0',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#3DD5F0' : '#fff',
